 ...
 * </p>
 * <ul>
 *   <li>{@link aml.impl.ModelContainerImpl#getPath <em>Path</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class ModelContainerImpl extends MinimalEObjectImpl.Container implements ModelContainer {
	...
	protected EClass eStaticClass() {
		return AmlPackage.Literals.MODEL_CONTAINER;
	}
	...
	public void setPath(String newPath) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AmlPackage.MODEL_CONTAINER__PATH, oldPath, path));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case AmlPackage.MODEL_CONTAINER__PATH:
				return getPath();
		}
