...
public class AmlSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case AmlPackage.AML_ROOT: {
				AMLRoot amlRoot = (AMLRoot)theEObject;
				T result = caseAMLRoot(amlRoot);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case AmlPackage.CAEX_CONTAINER: {
				CAEXContainer caexContainer = (CAEXContainer)theEObject;
				T result = caseCAEXContainer(caexContainer);
				if (result == null) result = caseModelContainer(caexContainer);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case AmlPackage.COLLADA_CONTAINER: {
				COLLADAContainer colladaContainer = (COLLADAContainer)theEObject;
				T result = caseCOLLADAContainer(colladaContainer);
				if (result == null) result = caseModelContainer(colladaContainer);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case AmlPackage.PL_COPEN_CONTAINER: {
				PLCopenContainer plCopenContainer = (PLCopenContainer)theEObject;
				T result = casePLCopenContainer(plCopenContainer);
				if (result == null) result = caseModelContainer(plCopenContainer);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case AmlPackage.MODEL_CONTAINER: {
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>AML Root</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>AML Root</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseAMLRoot(AMLRoot object) {
		return null;
	}
